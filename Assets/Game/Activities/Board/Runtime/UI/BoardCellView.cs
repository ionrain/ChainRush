...
namespace ChainRush.Board
{
    ...
    public sealed class BoardCellView :
        MonoBehaviour,
        IPointerDownHandler,
        IPointerUpHandler,
        ...
        IEndDragHandler
    {
        ...
        BoardUIController _controller;
        BoardItemView _itemView;
        EntityId _entityId;
        bool _selected;
        ...
        internal void Bind(BoardUIController controller, ActivityUICell cell)
        {
        ...
        internal bool BindItem(BoardItemView itemView, EntityId entityId)
        {
            if (itemView == null
                || !entityId.IsValid
        ...
        internal void UnbindItem(BoardItemView itemView, EntityId entityId)
        {
