...
/// Resolves capabilities from a <see cref="RoleCapabilitiesMapAsset"/> via
...
public sealed class UnitCapabilityProvider : MonoBehaviour, ICapabilityProvider
{
    ...
    [SerializeField] RoleCapabilitiesMapAsset roleMap;
    ...
    /// </summary>
    public void SetRoleMap(RoleCapabilitiesMapAsset m) { roleMap = m; }
