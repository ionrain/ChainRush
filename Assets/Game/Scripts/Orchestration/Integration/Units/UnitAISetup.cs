...
/// This component only sets the role (via <see cref="UnitClassRoleMapAsset"/>) and
...
public sealed class UnitAISetup : MonoBehaviour
{
    ...
    [SerializeField] UnitClassRoleMapAsset roleMap;

    [Tooltip("RoleAsset → CapabilitiesProfile. Resolved via unit's role identity.")]
    [SerializeField] RoleCapabilitiesMapAsset roleCapabilitiesMap;
