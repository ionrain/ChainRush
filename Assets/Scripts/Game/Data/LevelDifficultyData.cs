...
public class LevelDifficultyData : SerializedScriptableObject {
    public AnimationCurve refreshInterval = AnimationCurve.Linear(0, 5, 1, 5);

    public Dictionary<CellSelectPatternType, int> cellPatterns = new Dictionary<CellSelectPatternType, int>()
    {
    ...
    public Dictionary<CellItemType, AnimationCurve> refreshCooldowns = new();
